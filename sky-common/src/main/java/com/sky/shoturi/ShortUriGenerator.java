...
import com.sky.properties.ShortUrlProperties;
...
public class ShortUriGenerator {
    ...
    public  String getFullUrl(Long tradeNo, Long courierId, LocalDateTime expireTime){
        ...
        fullUrl.append(shortUrlProperties.getDomainName());
        //拼接真实资源地址  https://www.xxx.com/rider.html
        fullUrl.append(shortUrlProperties.getRealResource());
    ...
    public  String getShortUrl(String code){
        ...
        //拼接域名  https://www.xxx.com
        shortUrl.append(shortUrlProperties.getDomainName());
        //拼接短链前缀   https://www.xxx.com/r/
        shortUrl.append(shortUrlProperties.getShortUrlPrefix());
        //拼接code
