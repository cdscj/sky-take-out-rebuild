...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            // 解析对应的权限以及用户信息
            String loginType = (String) claims.get(Constants.LOGIN_TYPE_KEY);
            String uuid = (String) claims.get(Constants.LOGIN_USER_KEY);
            String userKey = null;
            if (Constants.LOGIN_TYPE_MANAGER.equals(loginType)) {
                userKey = getTokenKey(uuid);
            } else {
                userKey = getAppTokenKey(uuid);
            }
     ...
     * @param loginUser 用户类型
     * @return 令牌
     */
    public String createToken(LoginUser loginUser, String loginType) {
        ...
        claims.put(Constants.LOGIN_TYPE_KEY, loginType);
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        // 根据uuid将loginUser缓存
        String userKey = null;
        if (Constants.LOGIN_TYPE_MANAGER.equals(loginUser.getLoginType())) {
            userKey = getTokenKey(loginUser.getToken());
        } else {
            userKey = getAppTokenKey(loginUser.getToken());
        }
    ...
    private String getAppTokenKey(String uuid) {
        return Constants.LOGIN_APP_USER_KEY + uuid;
    }
    ...
    public String getAppUserName(){
        ...
        return loginUser.getAppUser().getUserName();
    }
}
